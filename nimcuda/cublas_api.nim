...
when not defined(CUBLAS_API_H):
  ...
  #discard "forward decl of cublasContext"
  type cublasContext = object
  type
  ...
  proc cublasGetCudartVersion*(): csize_t {.cdecl,
      importc: "cublasGetCudartVersion", dynlib: libName.}
  proc cublasSetWorkspace_v2*(handle: cublasHandle_t; workspace: pointer;
                             workspaceSizeInBytes: csize_t): cublasStatus_t {.
      cdecl, importc: "cublasSetWorkspace_v2", dynlib: libName.}
  ...
  proc cublasGetVectorAsync_64*(n: clonglong; elemSize: clonglong;
                               devicePtr: pointer; incx: clonglong;
                               hostPtr: pointer; incy: clonglong;
                               stream: cudaStream_t): cublasStatus_t {.cdecl,
  ...
  proc cublasSetMatrixAsync_64*(rows: clonglong; cols: clonglong;
                               elemSize: clonglong; A: pointer; lda: clonglong;
                               B: pointer; ldb: clonglong; stream: cudaStream_t): cublasStatus_t {.
      cdecl, importc: "cublasSetMatrixAsync_64", dynlib: libName.}
  proc cublasGetMatrixAsync*(rows: cint; cols: cint; elemSize: cint; A: pointer;
                            lda: cint; B: pointer; ldb: cint; stream: cudaStream_t): cublasStatus_t {.
      cdecl, importc: "cublasGetMatrixAsync", dynlib: libName.}
  proc cublasGetMatrixAsync_64*(rows: clonglong; cols: clonglong;
                               elemSize: clonglong; A: pointer; lda: clonglong;
                               B: pointer; ldb: clonglong; stream: cudaStream_t): cublasStatus_t {.
      cdecl, importc: "cublasGetMatrixAsync_64", dynlib: libName.}
  ...
  proc cublasNrm2Ex_64*(handle: cublasHandle_t; n: clonglong; x: pointer;
                       xType: cudaDataType; incx: clonglong; result: pointer;
  ...
  proc cublasSnrm2_v2_64*(handle: cublasHandle_t; n: clonglong; x: ptr cfloat;
                         incx: clonglong; result: ptr cfloat): cublasStatus_t {.cdecl,
  ...
  proc cublasDnrm2_v2_64*(handle: cublasHandle_t; n: clonglong; x: ptr cdouble;
                         incx: clonglong; result: ptr cdouble): cublasStatus_t {.
      cdecl, importc: "cublasDnrm2_v2_64", dynlib: libName.}
  ...
  proc cublasScnrm2_v2_64*(handle: cublasHandle_t; n: clonglong; x: ptr cuComplex;
                          incx: clonglong; result: ptr cfloat): cublasStatus_t {.
      cdecl, importc: "cublasScnrm2_v2_64", dynlib: libName.}
  ...
  proc cublasDznrm2_v2_64*(handle: cublasHandle_t; n: clonglong;
                          ...
                          result: ptr cdouble): cublasStatus_t {.cdecl,
      importc: "cublasDznrm2_v2_64", dynlib: libName.}
  ...
  proc cublasDotEx_64*(handle: cublasHandle_t; n: clonglong; x: pointer;
                      ...
                      yType: cudaDataType; incy: clonglong; result: pointer;
                      resultType: cudaDataType; executionType: cudaDataType): cublasStatus_t {.
  ...
  proc cublasCdotu_v2_64*(handle: cublasHandle_t; n: clonglong; x: ptr cuComplex;
                         ...
                         result: ptr cuComplex): cublasStatus_t {.cdecl,
  ...
  proc cublasZdotu_v2_64*(handle: cublasHandle_t; n: clonglong;
                         x: ptr cuDoubleComplex; incx: clonglong;
  ...
  proc cublasZdotc_v2_64*(handle: cublasHandle_t; n: clonglong;
                         x: ptr cuDoubleComplex; incx: clonglong;
                         y: ptr cuDoubleComplex; incy: clonglong;
                         result: ptr cuDoubleComplex): cublasStatus_t {.cdecl,
  ...
  proc cublasDaxpy_v2_64*(handle: cublasHandle_t; n: clonglong; alpha: ptr cdouble;
                         x: ptr cdouble; incx: clonglong; y: ptr cdouble;
                         incy: clonglong): cublasStatus_t {.cdecl,
      importc: "cublasDaxpy_v2_64", dynlib: libName.}
  ...
  proc cublasZcopy_v2_64*(handle: cublasHandle_t; n: clonglong;
                         x: ptr cuDoubleComplex; incx: clonglong;
                         y: ptr cuDoubleComplex; incy: clonglong): cublasStatus_t {.
  ...
  proc cublasZswap_v2_64*(handle: cublasHandle_t; n: clonglong;
                         x: ptr cuDoubleComplex; incx: clonglong;
                         y: ptr cuDoubleComplex; incy: clonglong): cublasStatus_t {.
  ...
  proc cublasIsamax_v2_64*(handle: cublasHandle_t; n: clonglong; x: ptr cfloat;
                          incx: clonglong; result: ptr clonglong): cublasStatus_t {.
  ...
  proc cublasIzamax_v2_64*(handle: cublasHandle_t; n: clonglong;
                          x: ptr cuDoubleComplex; incx: clonglong;
                          result: ptr clonglong): cublasStatus_t {.cdecl,
  ...
  proc cublasIamaxEx_64*(handle: cublasHandle_t; n: clonglong; x: pointer;
                        xType: cudaDataType; incx: clonglong; result: ptr clonglong): cublasStatus_t {.
  ...
  proc cublasDasum_v2_64*(handle: cublasHandle_t; n: clonglong; x: ptr cdouble;
                         incx: clonglong; result: ptr cdouble): cublasStatus_t {.
      cdecl, importc: "cublasDasum_v2_64", dynlib: libName.}
  ...
  proc cublasScasum_v2_64*(handle: cublasHandle_t; n: clonglong; x: ptr cuComplex;
                          incx: clonglong; result: ptr cfloat): cublasStatus_t {.
      cdecl, importc: "cublasScasum_v2_64", dynlib: libName.}
  ...
  proc cublasDzasum_v2_64*(handle: cublasHandle_t; n: clonglong;
                          x: ptr cuDoubleComplex; incx: clonglong;
                          result: ptr cdouble): cublasStatus_t {.cdecl,
      importc: "cublasDzasum_v2_64", dynlib: libName.}
  ...
  proc cublasZrot_v2_64*(handle: cublasHandle_t; n: clonglong;
                        x: ptr cuDoubleComplex; incx: clonglong;
                        y: ptr cuDoubleComplex; incy: clonglong; c: ptr cdouble;
                        s: ptr cuDoubleComplex): cublasStatus_t {.cdecl,
  ...
  proc cublasZdrot_v2_64*(handle: cublasHandle_t; n: clonglong;
                         x: ptr cuDoubleComplex; incx: clonglong;
                         y: ptr cuDoubleComplex; incy: clonglong; c: ptr cdouble;
                         s: ptr cdouble): cublasStatus_t {.cdecl,
  ...
  proc cublasRotgEx*(handle: cublasHandle_t; a: pointer; b: pointer;
                    abType: cudaDataType; c: pointer; s: pointer;
                    csType: cudaDataType; executiontype: cudaDataType): cublasStatus_t {.
      cdecl, importc: "cublasRotgEx", dynlib: libName.}
  ...
  proc cublasDgemv_v2_64*(handle: cublasHandle_t; trans: cublasOperation_t;
                         ...
                         A: ptr cdouble; lda: clonglong; x: ptr cdouble;
                         incx: clonglong; beta: ptr cdouble; y: ptr cdouble;
                         incy: clonglong): cublasStatus_t {.cdecl,
      importc: "cublasDgemv_v2_64", dynlib: libName.}
  ...
  proc cublasSgbmv_v2_64*(handle: cublasHandle_t; trans: cublasOperation_t;
                         ...
                         x: ptr cfloat; incx: clonglong; beta: ptr cfloat;
                         y: ptr cfloat; incy: clonglong): cublasStatus_t {.cdecl,
      importc: "cublasSgbmv_v2_64", dynlib: libName.}
  ...
  proc cublasZtpmv_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                         trans: cublasOperation_t; diag: cublasDiagType_t;
                         n: clonglong; AP: ptr cuDoubleComplex;
                         x: ptr cuDoubleComplex; incx: clonglong): cublasStatus_t {.
      cdecl, importc: "cublasZtpmv_v2_64", dynlib: libName.}
  ##  TRSV
  ...
  proc cublasZtpsv_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                         ...
                         n: clonglong; AP: ptr cuDoubleComplex;
                         x: ptr cuDoubleComplex; incx: clonglong): cublasStatus_t {.
      cdecl, importc: "cublasZtpsv_v2_64", dynlib: libName.}
  ##  TBSV
  ...
  proc cublasSsymv_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                         n: clonglong; alpha: ptr cfloat; A: ptr cfloat; lda: clonglong;
                         x: ptr cfloat; incx: clonglong; beta: ptr cfloat;
                         y: ptr cfloat; incy: clonglong): cublasStatus_t {.cdecl,
      importc: "cublasSsymv_v2_64", dynlib: libName.}
  ...
  proc cublasDsymv_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
      ...
      cdecl, importc: "cublasDsymv_v2_64", dynlib: libName.}
  ...
  proc cublasCsymv_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                         n: clonglong; alpha: ptr cuComplex; A: ptr cuComplex;
                         lda: clonglong; x: ptr cuComplex; incx: clonglong;
                         beta: ptr cuComplex; y: ptr cuComplex; incy: clonglong): cublasStatus_t {.
      cdecl, importc: "cublasCsymv_v2_64", dynlib: libName.}
  ...
  proc cublasZsymv_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
  ...
  proc cublasChemv_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                         n: clonglong; alpha: ptr cuComplex; A: ptr cuComplex;
                         lda: clonglong; x: ptr cuComplex; incx: clonglong;
                         beta: ptr cuComplex; y: ptr cuComplex; incy: clonglong): cublasStatus_t {.
      cdecl, importc: "cublasChemv_v2_64", dynlib: libName.}
  proc cublasZhemv_v2*(handle: cublasHandle_t; uplo: cublasFillMode_t; n: cint;
                      alpha: ptr cuDoubleComplex; A: ptr cuDoubleComplex; lda: cint;
                      x: ptr cuDoubleComplex; incx: cint; beta: ptr cuDoubleComplex;
                      y: ptr cuDoubleComplex; incy: cint): cublasStatus_t {.cdecl,
      importc: "cublasZhemv_v2", dynlib: libName.}
  proc cublasZhemv_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                         n: clonglong; alpha: ptr cuDoubleComplex;
                         A: ptr cuDoubleComplex; lda: clonglong;
                         x: ptr cuDoubleComplex; incx: clonglong;
                         beta: ptr cuDoubleComplex; y: ptr cuDoubleComplex;
  ...
  proc cublasSsbmv_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                         n: clonglong; k: clonglong; alpha: ptr cfloat; A: ptr cfloat;
                         lda: clonglong; x: ptr cfloat; incx: clonglong;
                         beta: ptr cfloat; y: ptr cfloat; incy: clonglong): cublasStatus_t {.
      cdecl, importc: "cublasSsbmv_v2_64", dynlib: libName.}
  ...
  proc cublasDsbmv_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
  ...
  proc cublasChbmv_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                         n: clonglong; k: clonglong; alpha: ptr cuComplex;
                         A: ptr cuComplex; lda: clonglong; x: ptr cuComplex;
                         incx: clonglong; beta: ptr cuComplex; y: ptr cuComplex;
                         incy: clonglong): cublasStatus_t {.cdecl,
      importc: "cublasChbmv_v2_64", dynlib: libName.}
  ...
  proc cublasZhbmv_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                         n: clonglong; k: clonglong; alpha: ptr cuDoubleComplex;
                         A: ptr cuDoubleComplex; lda: clonglong;
                         x: ptr cuDoubleComplex; incx: clonglong;
                         beta: ptr cuDoubleComplex; y: ptr cuDoubleComplex;
                         incy: clonglong): cublasStatus_t {.cdecl,
  ...
  proc cublasSspmv_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                         n: clonglong; alpha: ptr cfloat; AP: ptr cfloat; x: ptr cfloat;
                         incx: clonglong; beta: ptr cfloat; y: ptr cfloat;
                         incy: clonglong): cublasStatus_t {.cdecl,
      importc: "cublasSspmv_v2_64", dynlib: libName.}
  ...
  proc cublasDspmv_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                         n: clonglong; alpha: ptr cdouble; AP: ptr cdouble;
                         x: ptr cdouble; incx: clonglong; beta: ptr cdouble;
                         y: ptr cdouble; incy: clonglong): cublasStatus_t {.cdecl,
  ...
  proc cublasChpmv_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                         n: clonglong; alpha: ptr cuComplex; AP: ptr cuComplex;
                         x: ptr cuComplex; incx: clonglong; beta: ptr cuComplex;
                         y: ptr cuComplex; incy: clonglong): cublasStatus_t {.cdecl,
  ...
  proc cublasZhpmv_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                         n: clonglong; alpha: ptr cuDoubleComplex;
                         AP: ptr cuDoubleComplex; x: ptr cuDoubleComplex;
                         incx: clonglong; beta: ptr cuDoubleComplex;
                         y: ptr cuDoubleComplex; incy: clonglong): cublasStatus_t {.
      cdecl, importc: "cublasZhpmv_v2_64", dynlib: libName.}
  ##  GER
  ...
  proc cublasSger_v2_64*(handle: cublasHandle_t; m: clonglong; n: clonglong;
                        alpha: ptr cfloat; x: ptr cfloat; incx: clonglong;
                        y: ptr cfloat; incy: clonglong; A: ptr cfloat; lda: clonglong): cublasStatus_t {.
  ...
  proc cublasSsyr_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                        n: clonglong; alpha: ptr cfloat; x: ptr cfloat; incx: clonglong;
                        A: ptr cfloat; lda: clonglong): cublasStatus_t {.cdecl,
  ...
  proc cublasDsyr_v2*(handle: cublasHandle_t; uplo: cublasFillMode_t; n: cint;
      ...
      dynlib: libName.}
  proc cublasDsyr_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                        n: clonglong; alpha: ptr cdouble; x: ptr cdouble;
                        incx: clonglong; A: ptr cdouble; lda: clonglong): cublasStatus_t {.
      cdecl, importc: "cublasDsyr_v2_64", dynlib: libName.}
  ...
  proc cublasCsyr_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                        n: clonglong; alpha: ptr cuComplex; x: ptr cuComplex;
                        incx: clonglong; A: ptr cuComplex; lda: clonglong): cublasStatus_t {.
      cdecl, importc: "cublasCsyr_v2_64", dynlib: libName.}
  ...
  proc cublasZsyr_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                        n: clonglong; alpha: ptr cuDoubleComplex;
                        x: ptr cuDoubleComplex; incx: clonglong;
                        A: ptr cuDoubleComplex; lda: clonglong): cublasStatus_t {.
  ...
  proc cublasCher_v2*(handle: cublasHandle_t; uplo: cublasFillMode_t; n: cint;
      ...
      dynlib: libName.}
  proc cublasCher_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                        n: clonglong; alpha: ptr cfloat; x: ptr cuComplex;
                        incx: clonglong; A: ptr cuComplex; lda: clonglong): cublasStatus_t {.
      cdecl, importc: "cublasCher_v2_64", dynlib: libName.}
  ...
  proc cublasZher_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                        n: clonglong; alpha: ptr cdouble; x: ptr cuDoubleComplex;
                        incx: clonglong; A: ptr cuDoubleComplex; lda: clonglong): cublasStatus_t {.
      cdecl, importc: "cublasZher_v2_64", dynlib: libName.}
  ##  SPR/HPR
  ...
  proc cublasSspr_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                        n: clonglong; alpha: ptr cfloat; x: ptr cfloat; incx: clonglong;
                        AP: ptr cfloat): cublasStatus_t {.cdecl,
      importc: "cublasSspr_v2_64", dynlib: libName.}
  ...
  proc cublasDspr_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                        n: clonglong; alpha: ptr cdouble; x: ptr cdouble;
                        incx: clonglong; AP: ptr cdouble): cublasStatus_t {.cdecl,
  ...
  proc cublasChpr_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                        n: clonglong; alpha: ptr cfloat; x: ptr cuComplex;
                        incx: clonglong; AP: ptr cuComplex): cublasStatus_t {.cdecl,
  ...
  proc cublasZhpr_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                        n: clonglong; alpha: ptr cdouble; x: ptr cuDoubleComplex;
                        incx: clonglong; AP: ptr cuDoubleComplex): cublasStatus_t {.
      cdecl, importc: "cublasZhpr_v2_64", dynlib: libName.}
  ##  SYR2/HER2
  ...
  proc cublasSsyr2_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                         n: clonglong; alpha: ptr cfloat; x: ptr cfloat;
                         incx: clonglong; y: ptr cfloat; incy: clonglong;
                         A: ptr cfloat; lda: clonglong): cublasStatus_t {.cdecl,
      importc: "cublasSsyr2_v2_64", dynlib: libName.}
  ...
  proc cublasDsyr2_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                         n: clonglong; alpha: ptr cdouble; x: ptr cdouble;
                         incx: clonglong; y: ptr cdouble; incy: clonglong;
                         A: ptr cdouble; lda: clonglong): cublasStatus_t {.cdecl,
      importc: "cublasDsyr2_v2_64", dynlib: libName.}
  ...
  proc cublasCsyr2_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                         n: clonglong; alpha: ptr cuComplex; x: ptr cuComplex;
                         incx: clonglong; y: ptr cuComplex; incy: clonglong;
  ...
  proc cublasZsyr2_v2*(handle: cublasHandle_t; uplo: cublasFillMode_t; n: cint;
      ...
      dynlib: libName.}
  proc cublasZsyr2_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                         n: clonglong; alpha: ptr cuDoubleComplex;
                         x: ptr cuDoubleComplex; incx: clonglong;
                         y: ptr cuDoubleComplex; incy: clonglong;
                         A: ptr cuDoubleComplex; lda: clonglong): cublasStatus_t {.
  ...
  proc cublasCher2_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                         n: clonglong; alpha: ptr cuComplex; x: ptr cuComplex;
                         incx: clonglong; y: ptr cuComplex; incy: clonglong;
                         A: ptr cuComplex; lda: clonglong): cublasStatus_t {.cdecl,
  ...
  proc cublasZher2_v2*(handle: cublasHandle_t; uplo: cublasFillMode_t; n: cint;
      ...
      dynlib: libName.}
  proc cublasZher2_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                         n: clonglong; alpha: ptr cuDoubleComplex;
                         x: ptr cuDoubleComplex; incx: clonglong;
                         y: ptr cuDoubleComplex; incy: clonglong;
                         A: ptr cuDoubleComplex; lda: clonglong): cublasStatus_t {.
  ...
  proc cublasSspr2_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                         n: clonglong; alpha: ptr cfloat; x: ptr cfloat;
                         incx: clonglong; y: ptr cfloat; incy: clonglong;
                         AP: ptr cfloat): cublasStatus_t {.cdecl,
  ...
  proc cublasDspr2_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                         n: clonglong; alpha: ptr cdouble; x: ptr cdouble;
                         incx: clonglong; y: ptr cdouble; incy: clonglong;
                         AP: ptr cdouble): cublasStatus_t {.cdecl,
      importc: "cublasDspr2_v2_64", dynlib: libName.}
  ...
  proc cublasChpr2_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                         n: clonglong; alpha: ptr cuComplex; x: ptr cuComplex;
                         incx: clonglong; y: ptr cuComplex; incy: clonglong;
                         AP: ptr cuComplex): cublasStatus_t {.cdecl,
      importc: "cublasChpr2_v2_64", dynlib: libName.}
  ...
  proc cublasZhpr2_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                         n: clonglong; alpha: ptr cuDoubleComplex;
                         x: ptr cuDoubleComplex; incx: clonglong;
                         y: ptr cuDoubleComplex; incy: clonglong;
                         AP: ptr cuDoubleComplex): cublasStatus_t {.cdecl,
  ...
  proc cublasSgemvBatched_64*(handle: cublasHandle_t; trans: cublasOperation_t;
                             ...
                             xarray: ptr ptr cfloat; incx: clonglong;
                             beta: ptr cfloat; yarray: ptr ptr cfloat; incy: clonglong;
  ...
  proc cublasDgemvBatched*(handle: cublasHandle_t; trans: cublasOperation_t; m: cint;
                          n: cint; alpha: ptr cdouble; Aarray: ptr ptr cdouble;
                          lda: cint; xarray: ptr ptr cdouble; incx: cint;
                          beta: ptr cdouble; yarray: ptr ptr cdouble; incy: cint;
                          batchCount: cint): cublasStatus_t {.cdecl,
      importc: "cublasDgemvBatched", dynlib: libName.}
  proc cublasDgemvBatched_64*(handle: cublasHandle_t; trans: cublasOperation_t;
      ...
      cdecl, importc: "cublasDgemvBatched_64", dynlib: libName.}
  ...
  proc cublasSgemvStridedBatched_64*(handle: cublasHandle_t;
                                    ...
                                    x: ptr cfloat; incx: clonglong;
                                    stridex: clonglong; beta: ptr cfloat;
                                    y: ptr cfloat; incy: clonglong;
  ...
  proc cublasZgemvStridedBatched*(handle: cublasHandle_t; trans: cublasOperation_t;
                                 ...
                                 beta: ptr cuDoubleComplex; y: ptr cuDoubleComplex;
                                 incy: cint; stridey: clonglong; batchCount: cint): cublasStatus_t {.
  ...
  proc cublasDgemm_v2_64*(handle: cublasHandle_t; transa: cublasOperation_t;
                         transb: cublasOperation_t; m: clonglong; n: clonglong;
                         k: clonglong; alpha: ptr cdouble; A: ptr cdouble;
                         lda: clonglong; B: ptr cdouble; ldb: clonglong;
                         beta: ptr cdouble; C: ptr cdouble; ldc: clonglong): cublasStatus_t {.
      cdecl, importc: "cublasDgemm_v2_64", dynlib: libName.}
  ...
  proc cublasSgemmEx_64*(handle: cublasHandle_t; transa: cublasOperation_t;
                        transb: cublasOperation_t; m: clonglong; n: clonglong;
                        k: clonglong; alpha: ptr cfloat; A: pointer;
                        Atype: cudaDataType; lda: clonglong; B: pointer;
                        Btype: cudaDataType; ldb: clonglong; beta: ptr cfloat;
                        C: pointer; Ctype: cudaDataType; ldc: clonglong): cublasStatus_t {.
  ...
  proc cublasGemmEx_64*(handle: cublasHandle_t; transa: cublasOperation_t;
                       ...
                       lda: clonglong; B: pointer; Btype: cudaDataType;
                       ldb: clonglong; beta: pointer; C: pointer; Ctype: cudaDataType;
                       ldc: clonglong; computeType: cublasComputeType_t;
                       algo: cublasGemmAlgo_t): cublasStatus_t {.cdecl,
      importc: "cublasGemmEx_64", dynlib: libName.}
  ...
  proc cublasCsyrk3mEx_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                          ...
                          alpha: ptr cuComplex; A: pointer; Atype: cudaDataType;
                          lda: clonglong; beta: ptr cuComplex; C: pointer;
                          Ctype: cudaDataType; ldc: clonglong): cublasStatus_t {.
      cdecl, importc: "cublasCsyrk3mEx_64", dynlib: libName.}
  ##  HERK
  ...
  proc cublasCherk3mEx_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                          ...
                          lda: clonglong; beta: ptr cfloat; C: pointer;
                          Ctype: cudaDataType; ldc: clonglong): cublasStatus_t {.
      cdecl, importc: "cublasCherk3mEx_64", dynlib: libName.}
  ##  SYR2K / HER2K
  ...
  proc cublasSsyr2k_v2_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                          trans: cublasOperation_t; n: clonglong; k: clonglong;
                          alpha: ptr cfloat; A: ptr cfloat; lda: clonglong;
                          B: ptr cfloat; ldb: clonglong; beta: ptr cfloat;
                          C: ptr cfloat; ldc: clonglong): cublasStatus_t {.cdecl,
      importc: "cublasSsyr2k_v2_64", dynlib: libName.}
  ...
  proc cublasDsyrkx_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                       ...
                       B: ptr cdouble; ldb: clonglong; beta: ptr cdouble;
                       C: ptr cdouble; ldc: clonglong): cublasStatus_t {.cdecl,
      importc: "cublasDsyrkx_64", dynlib: libName.}
  ...
  proc cublasZsyrkx_64*(handle: cublasHandle_t; uplo: cublasFillMode_t;
                       ...
                       beta: ptr cuDoubleComplex; C: ptr cuDoubleComplex;
                       ldc: clonglong): cublasStatus_t {.cdecl,
      importc: "cublasZsyrkx_64", dynlib: libName.}
  ...
  proc cublasSsymm_v2_64*(handle: cublasHandle_t; side: cublasSideMode_t;
                         ...
                         B: ptr cfloat; ldb: clonglong; beta: ptr cfloat; C: ptr cfloat;
                         ldc: clonglong): cublasStatus_t {.cdecl,
      importc: "cublasSsymm_v2_64", dynlib: libName.}
  ...
  proc cublasStrsm_v2_64*(handle: cublasHandle_t; side: cublasSideMode_t;
                         ...
                         alpha: ptr cfloat; A: ptr cfloat; lda: clonglong;
                         B: ptr cfloat; ldb: clonglong): cublasStatus_t {.cdecl,
  ...
  proc cublasDgemmBatched_64*(handle: cublasHandle_t; transa: cublasOperation_t;
                             transb: cublasOperation_t; m: clonglong; n: clonglong;
                             k: clonglong; alpha: ptr cdouble;
                             Aarray: ptr ptr cdouble; lda: clonglong;
                             Barray: ptr ptr cdouble; ldb: clonglong;
                             beta: ptr cdouble; Carray: ptr ptr cdouble;
                             ldc: clonglong; batchCount: clonglong): cublasStatus_t {.
      cdecl, importc: "cublasDgemmBatched_64", dynlib: libName.}
  ...
  proc cublasCgemmStridedBatched_64*(handle: cublasHandle_t;
                                    ...
                                    strideC: clonglong; batchCount: clonglong): cublasStatus_t {.
      cdecl, importc: "cublasCgemmStridedBatched_64", dynlib: libName.}
  ...
  proc cublasGemmBatchedEx*(handle: cublasHandle_t; transa: cublasOperation_t;
                           ...
                           algo: cublasGemmAlgo_t): cublasStatus_t {.cdecl,
      importc: "cublasGemmBatchedEx", dynlib: libName.}
  proc cublasGemmBatchedEx_64*(handle: cublasHandle_t; transa: cublasOperation_t;
                              ...
                              Barray: ptr pointer; Btype: cudaDataType;
                              ldb: clonglong; beta: pointer; Carray: ptr pointer;
                              Ctype: cudaDataType; ldc: clonglong;
                              batchCount: clonglong;
                              computeType: cublasComputeType_t;
                              algo: cublasGemmAlgo_t): cublasStatus_t {.cdecl,
      importc: "cublasGemmBatchedEx_64", dynlib: libName.}
  proc cublasGemmStridedBatchedEx*(handle: cublasHandle_t;
                                  transa: cublasOperation_t;
                                  transb: cublasOperation_t; m: cint; n: cint;
                                  k: cint; alpha: pointer; A: pointer;
  ...
  proc cublasGemmStridedBatchedEx_64*(handle: cublasHandle_t;
                                     ...
                                     A: pointer; Atype: cudaDataType;
                                     lda: clonglong; strideA: clonglong; B: pointer;
      ...
      cdecl, importc: "cublasGemmStridedBatchedEx_64", dynlib: libName.}
  ...
  proc cublasSgeam_64*(handle: cublasHandle_t; transa: cublasOperation_t;
                      transb: cublasOperation_t; m: clonglong; n: clonglong;
                      alpha: ptr cfloat; A: ptr cfloat; lda: clonglong;
                      beta: ptr cfloat; B: ptr cfloat; ldb: clonglong; C: ptr cfloat;
                      ldc: clonglong): cublasStatus_t {.cdecl,
      importc: "cublasSgeam_64", dynlib: libName.}
  ...
  proc cublasCtrsmBatched_64*(handle: cublasHandle_t; side: cublasSideMode_t;
                             ...
                             lda: clonglong; B: ptr ptr cuComplex; ldb: clonglong;
                             batchCount: clonglong): cublasStatus_t {.cdecl,
      importc: "cublasCtrsmBatched_64", dynlib: libName.}
  ...
  proc cublasZtrsmBatched_64*(handle: cublasHandle_t; side: cublasSideMode_t;
                             ...
                             diag: cublasDiagType_t; m: clonglong; n: clonglong;
                             alpha: ptr cuDoubleComplex;
                             A: ptr ptr cuDoubleComplex; lda: clonglong;
                             B: ptr ptr cuDoubleComplex; ldb: clonglong;
                             batchCount: clonglong): cublasStatus_t {.cdecl,
