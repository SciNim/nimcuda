...
when not defined(CURAND_H):
  ...
  ##
  discard "forward decl of curandGenerator_st"
  type curandGenerator_st = object
  type
  ...
  when false:
    ...
    proc curandSetPseudoRandomGeneratorSeed*(generator: curandGenerator_t;
        seed: culonglong): curandStatus_t {.cdecl,
        importc: "curandSetPseudoRandomGeneratorSeed", dynlib: libName.}
    ##
    ...
    ##
    proc curandGenerate*(generator: curandGenerator_t; outputPtr: ptr cuint;
                        num: csize_t): curandStatus_t {.cdecl,
        importc: "curandGenerate", dynlib: libName.}
    ##
    ...
    ##  - CURAND_STATUS_SUCCESS if the results were generated successfully \n
    ##
    proc curandGenerateUniform*(generator: curandGenerator_t;
                               outputPtr: ptr cfloat; num: csize_t): curandStatus_t {.
        cdecl, importc: "curandGenerateUniform", dynlib: libName.}
    ##
    ...
    proc curandGenerateNormalDouble*(generator: curandGenerator_t;
                                    outputPtr: ptr cdouble; n: csize_t;
                                    mean: cdouble; stddev: cdouble): curandStatus_t {.
        cdecl, importc: "curandGenerateNormalDouble", dynlib: libName.}
    ##
    ...
    ##
    proc curandCreatePoissonDistribution*(lambda: cdouble;
    ...
    proc curandGeneratePoissonMethod*(generator: curandGenerator_t;
                                     outputPtr: ptr cuint; n: csize_t;
                                     lambda: cdouble; `method`: curandMethod_t): curandStatus_t {.
        cdecl, importc: "curandGeneratePoissonMethod", dynlib: libName.}
    proc curandGenerateBinomial*(generator: curandGenerator_t;
                                outputPtr: ptr cuint; num: csize_t; n: cuint;
                                p: cdouble): curandStatus_t {.cdecl,
        importc: "curandGenerateBinomial", dynlib: libName.}
    ##  just for internal usage
    ...
    ##
    ##  The array contains vectors for many dimensions.  Each dimension
    ##  has 64 vectors.  Each individual vector is an culonglong.
    ##
    ##  Legal values for \p set are:
    ...
    ##
    ##  The array contains constants for many dimensions.  Each dimension
    ##  has a single culonglong constant.
    ##
    ##  \param constants - Address of pointer in which to return scramble constants
    ##
    ##  \return
