...
when not defined(CUSPARSE_H):
  ...
  const
    ...
    CUSPARSE_VER_MINOR* = 0
    CUSPARSE_VER_PATCH* = 1
    CUSPARSE_VER_BUILD* = 140
    CUSPARSE_VERSION* = (
  ...
  ## ##############################################################################
  discard "forward decl of cusparseContext"
  type
    #cusparseHandle_t* = ptr cusparseContext
    cusparseHandle_t* = pointer
  discard "forward decl of cusparseMatDescr"
  type
    #cusparseMatDescr_t* = ptr cusparseMatDescr
    cusparseMatDescr_t* = pointer
  discard "forward decl of bsrsv2Info"
  type
    #bsrsv2Info_t* = ptr bsrsv2Info
    bsrsv2Info_t* = pointer
  discard "forward decl of bsrsm2Info"
  type
    #bsrsm2Info_t* = ptr bsrsm2Info
    bsrsm2Info_t* = pointer
  discard "forward decl of csric02Info"
  type
    #csric02Info_t* = ptr csric02Info
    csric02Info_t* = pointer
  discard "forward decl of bsric02Info"
  type
    #bsric02Info_t* = ptr bsric02Info
    bsric02Info_t* = pointer
  discard "forward decl of csrilu02Info"
  type
    #csrilu02Info_t* = ptr csrilu02Info
    csrilu02Info_t* = pointer
  discard "forward decl of bsrilu02Info"
  type
    #bsrilu02Info_t* = ptr bsrilu02Info
    bsrilu02Info_t* = pointer
  discard "forward decl of csru2csrInfo"
  type
    #csru2csrInfo_t* = ptr csru2csrInfo
    csru2csrInfo_t* = pointer
  discard "forward decl of cusparseColorInfo"
  type
    #cusparseColorInfo_t* = ptr cusparseColorInfo
    cusparseColorInfo_t* = pointer
  discard "forward decl of pruneInfo"
  type
  ...
  type
    cusparseStatus_t* {.size: sizeof(cint).} = enum
      ...
      CUSPARSE_STATUS_ZERO_PIVOT = 9, CUSPARSE_STATUS_NOT_SUPPORTED = 10,
  ...
  proc cusparseSbsrsm2_solve*(handle: cusparseHandle_t; dirA: cusparseDirection_t;
                             ...
                             blockSize: cint; info: bsrsm2Info_t; B: ptr cfloat;
                             ldb: cint; X: ptr cfloat; ldx: cint;
                             policy: cusparseSolvePolicy_t; pBuffer: pointer): cusparseStatus_t {.
  ...
  proc cusparseDbsrsm2_solve*(handle: cusparseHandle_t; dirA: cusparseDirection_t;
                             ...
                             bsrSortedColInd: ptr cint; blockSize: cint;
                             info: bsrsm2Info_t; B: ptr cdouble; ldb: cint;
  ...
  proc cusparseCbsrsm2_solve*(handle: cusparseHandle_t; dirA: cusparseDirection_t;
                             ...
                             bsrSortedVal: ptr cuComplex;
                             bsrSortedRowPtr: ptr cint; bsrSortedColInd: ptr cint;
                             blockSize: cint; info: bsrsm2Info_t; B: ptr cuComplex;
                             ldb: cint; X: ptr cuComplex; ldx: cint;
                             policy: cusparseSolvePolicy_t; pBuffer: pointer): cusparseStatus_t {.
  ...
  proc cusparseZbsrsm2_solve*(handle: cusparseHandle_t; dirA: cusparseDirection_t;
                             ...
                             B: ptr cuDoubleComplex; ldb: cint;
  ...
  proc cusparseZgtsv2_bufferSizeExt*(handle: cusparseHandle_t; m: cint; n: cint;
                                    dl: ptr cuDoubleComplex;
                                    d: ptr cuDoubleComplex;
  ...
  proc cusparseSgtsv2_nopivot*(handle: cusparseHandle_t; m: cint; n: cint;
                              dl: ptr cfloat; d: ptr cfloat; du: ptr cfloat;
                              B: ptr cfloat; ldb: cint; pBuffer: pointer): cusparseStatus_t {.
      cdecl, importc: "cusparseSgtsv2_nopivot", dynlib: libName.}
  ...
  proc cusparseDgtsv2StridedBatch*(handle: cusparseHandle_t; m: cint;
                                  dl: ptr cdouble; d: ptr cdouble; du: ptr cdouble;
                                  x: ptr cdouble; batchCount: cint;
                                  batchStride: cint; pBuffer: pointer): cusparseStatus_t {.
      cdecl, importc: "cusparseDgtsv2StridedBatch", dynlib: libName.}
  proc cusparseCgtsv2StridedBatch*(handle: cusparseHandle_t; m: cint;
                                  dl: ptr cuComplex; d: ptr cuComplex;
                                  du: ptr cuComplex; x: ptr cuComplex;
                                  batchCount: cint; batchStride: cint;
                                  pBuffer: pointer): cusparseStatus_t {.cdecl,
      importc: "cusparseCgtsv2StridedBatch", dynlib: libName.}
  ...
  proc cusparseCgtsvInterleavedBatch_bufferSizeExt*(handle: cusparseHandle_t;
      ...
      cdecl, importc: "cusparseCgtsvInterleavedBatch_bufferSizeExt",
      dynlib: libName.}
  ...
  proc cusparseSgtsvInterleavedBatch*(handle: cusparseHandle_t; algo: cint; m: cint;
                                     dl: ptr cfloat; d: ptr cfloat; du: ptr cfloat;
                                     x: ptr cfloat; batchCount: cint;
                                     pBuffer: pointer): cusparseStatus_t {.cdecl,
      importc: "cusparseSgtsvInterleavedBatch", dynlib: libName.}
  proc cusparseDgtsvInterleavedBatch*(handle: cusparseHandle_t; algo: cint; m: cint;
                                     dl: ptr cdouble; d: ptr cdouble; du: ptr cdouble;
                                     x: ptr cdouble; batchCount: cint;
                                     pBuffer: pointer): cusparseStatus_t {.cdecl,
      importc: "cusparseDgtsvInterleavedBatch", dynlib: libName.}
  ...
  proc cusparseZgtsvInterleavedBatch*(handle: cusparseHandle_t; algo: cint; m: cint;
                                     ...
                                     d: ptr cuDoubleComplex;
                                     du: ptr cuDoubleComplex;
                                     x: ptr cuDoubleComplex; batchCount: cint;
                                     pBuffer: pointer): cusparseStatus_t {.cdecl,
      importc: "cusparseZgtsvInterleavedBatch", dynlib: libName.}
  proc cusparseSgpsvInterleavedBatch_bufferSizeExt*(handle: cusparseHandle_t;
      ...
      cdecl, importc: "cusparseSgpsvInterleavedBatch_bufferSizeExt",
      dynlib: libName.}
  proc cusparseDgpsvInterleavedBatch_bufferSizeExt*(handle: cusparseHandle_t;
      ...
      cdecl, importc: "cusparseDgpsvInterleavedBatch_bufferSizeExt",
      dynlib: libName.}
  ...
  proc cusparseZgpsvInterleavedBatch_bufferSizeExt*(handle: cusparseHandle_t;
      ...
      cdecl, importc: "cusparseZgpsvInterleavedBatch_bufferSizeExt",
      dynlib: libName.}
  ...
  proc cusparseZgpsvInterleavedBatch*(handle: cusparseHandle_t; algo: cint; m: cint;
                                     ...
                                     d: ptr cuDoubleComplex;
                                     du: ptr cuDoubleComplex;
                                     dw: ptr cuDoubleComplex;
                                     x: ptr cuDoubleComplex; batchCount: cint;
                                     pBuffer: pointer): cusparseStatus_t {.cdecl,
      importc: "cusparseZgpsvInterleavedBatch", dynlib: libName.}
  ## ##############################################################################
  ## # EXTRA ROUTINES
  ## ##############################################################################
  ...
  proc cusparseScsrgeam2*(handle: cusparseHandle_t; m: cint; n: cint;
  ...
  proc cusparseDcsrgeam2*(handle: cusparseHandle_t; m: cint; n: cint;
  ...
  proc cusparseCcsrgeam2*(handle: cusparseHandle_t; m: cint; n: cint;
                         ...
                         csrSortedRowPtrA: ptr cint; csrSortedColIndA: ptr cint;
                         beta: ptr cuComplex; descrB: cusparseMatDescr_t; nnzB: cint;
  ...
  proc cusparseCnnz_compress*(handle: cusparseHandle_t; m: cint;
                             ...
                             csrSortedValA: ptr cuComplex;
                             csrSortedRowPtrA: ptr cint; nnzPerRow: ptr cint;
                             nnzC: ptr cint; tol: cuComplex): cusparseStatus_t {.
  ...
  proc cusparseSpruneDense2csr_bufferSizeExt*(handle: cusparseHandle_t; m: cint;
      n: cint; A: ptr cfloat; lda: cint; threshold: ptr cfloat;
      descrC: cusparseMatDescr_t; csrSortedValC: ptr cfloat;
      csrSortedRowPtrC: ptr cint; csrSortedColIndC: ptr cint;
      pBufferSizeInBytes: ptr csize_t): cusparseStatus_t {.cdecl,
  ...
  proc cusparseSpruneCsr2csr_bufferSizeExt*(handle: cusparseHandle_t; m: cint;
  ...
  proc cusparseDpruneCsr2csr_bufferSizeExt*(handle: cusparseHandle_t; m: cint;
  ...
  proc cusparseSpruneCsr2csrNnz*(handle: cusparseHandle_t; m: cint; n: cint;
  ...
  proc cusparseDpruneCsr2csrNnz*(handle: cusparseHandle_t; m: cint; n: cint;
                                nnzA: cint; descrA: cusparseMatDescr_t;
                                csrSortedValA: ptr cdouble;
                                csrSortedRowPtrA: ptr cint;
  ...
  proc cusparseSpruneDense2csrByPercentage_bufferSizeExt*(
      handle: cusparseHandle_t; m: cint; n: cint; A: ptr cfloat; lda: cint;
      percentage: cfloat; descrC: cusparseMatDescr_t; csrSortedValC: ptr cfloat;
      csrSortedRowPtrC: ptr cint; csrSortedColIndC: ptr cint; info: pruneInfo_t;
      pBufferSizeInBytes: ptr csize_t): cusparseStatus_t {.cdecl,
      importc: "cusparseSpruneDense2csrByPercentage_bufferSizeExt",
      dynlib: libName.}
  proc cusparseDpruneDense2csrByPercentage_bufferSizeExt*(
      handle: cusparseHandle_t; m: cint; n: cint; A: ptr cdouble; lda: cint;
      percentage: cfloat; descrC: cusparseMatDescr_t; csrSortedValC: ptr cdouble;
      csrSortedRowPtrC: ptr cint; csrSortedColIndC: ptr cint; info: pruneInfo_t;
      pBufferSizeInBytes: ptr csize_t): cusparseStatus_t {.cdecl,
      importc: "cusparseDpruneDense2csrByPercentage_bufferSizeExt",
      dynlib: libName.}
  proc cusparseSpruneDense2csrNnzByPercentage*(handle: cusparseHandle_t; m: cint;
      ...
      pBuffer: pointer): cusparseStatus_t {.cdecl,
      importc: "cusparseSpruneDense2csrNnzByPercentage", dynlib: libName.}
  proc cusparseDpruneDense2csrNnzByPercentage*(handle: cusparseHandle_t; m: cint;
      ...
      csrRowPtrC: ptr cint; nnzTotalDevHostPtr: ptr cint; info: pruneInfo_t;
      pBuffer: pointer): cusparseStatus_t {.cdecl,
      importc: "cusparseDpruneDense2csrNnzByPercentage", dynlib: libName.}
  proc cusparseSpruneDense2csrByPercentage*(handle: cusparseHandle_t; m: cint;
      n: cint; A: ptr cfloat; lda: cint; percentage: cfloat; descrC: cusparseMatDescr_t;
      csrSortedValC: ptr cfloat; csrSortedRowPtrC: ptr cint;
      csrSortedColIndC: ptr cint; info: pruneInfo_t; pBuffer: pointer): cusparseStatus_t {.
      cdecl, importc: "cusparseSpruneDense2csrByPercentage", dynlib: libName.}
  proc cusparseDpruneDense2csrByPercentage*(handle: cusparseHandle_t; m: cint;
      n: cint; A: ptr cdouble; lda: cint; percentage: cfloat; descrC: cusparseMatDescr_t;
      csrSortedValC: ptr cdouble; csrSortedRowPtrC: ptr cint;
      csrSortedColIndC: ptr cint; info: pruneInfo_t; pBuffer: pointer): cusparseStatus_t {.
  ...
  proc cusparseSpruneCsr2csrByPercentage_bufferSizeExt*(handle: cusparseHandle_t;
      ...
      cdecl, importc: "cusparseSpruneCsr2csrByPercentage_bufferSizeExt",
      dynlib: libName.}
  ...
  proc cusparseSpruneCsr2csrByPercentage*(handle: cusparseHandle_t; m: cint; n: cint;
      ...
      csrSortedRowPtrC: ptr cint; csrSortedColIndC: ptr cint; info: pruneInfo_t;
      pBuffer: pointer): cusparseStatus_t {.cdecl,
      importc: "cusparseSpruneCsr2csrByPercentage", dynlib: libName.}
  proc cusparseDpruneCsr2csrByPercentage*(handle: cusparseHandle_t; m: cint; n: cint;
      ...
      csrSortedRowPtrC: ptr cint; csrSortedColIndC: ptr cint; info: pruneInfo_t;
      pBuffer: pointer): cusparseStatus_t {.cdecl,
      importc: "cusparseDpruneCsr2csrByPercentage", dynlib: libName.}
  ## ##############################################################################
  ## # CSR2CSC
  ## ##############################################################################
  type
  ...
  proc cusparseCsr2cscEx2_bufferSize*(handle: cusparseHandle_t; m: cint; n: cint;
                                     nnz: cint; csrVal: pointer;
                                     csrRowPtr: ptr cint; csrColInd: ptr cint;
                                     cscVal: pointer; cscColPtr: ptr cint;
                                     cscRowInd: ptr cint; valType: cudaDataType;
                                     copyValues: cusparseAction_t;
  ...
  ## ------------------------------------------------------------------------------
  discard "forward decl of cusparseSpVecDescr"
  discard "forward decl of cusparseDnVecDescr"
  discard "forward decl of cusparseSpMatDescr"
  discard "forward decl of cusparseDnMatDescr"
  type
    #cusparseSpVecDescr_t* = ptr cusparseSpVecDescr
    cusparseSpVecDescr_t* = pointer
    #cusparseDnVecDescr_t* = ptr cusparseDnVecDescr
    cusparseDnVecDescr_t* = pointer
    #cusparseSpMatDescr_t* = ptr cusparseSpMatDescr
    cusparseSpMatDescr_t* = pointer
    #cusparseDnMatDescr_t* = ptr cusparseDnMatDescr
    cusparseDnMatDescr_t* = pointer
    #cusparseConstSpVecDescr_t* = ptr cusparseSpVecDescr
    cusparseConstSpVecDescr_t* = pointer
    #cusparseConstDnVecDescr_t* = ptr cusparseDnVecDescr
    cusparseConstDnVecDescr_t* = pointer
    #cusparseConstSpMatDescr_t* = ptr cusparseSpMatDescr
    cusparseConstSpMatDescr_t* = pointer
    #cusparseConstDnMatDescr_t* = ptr cusparseDnMatDescr
    cusparseConstDnMatDescr_t* = pointer
  ##  #############################################################################
  ...
  proc cusparseSpVecGet*(spVecDescr: cusparseSpVecDescr_t; size: ptr clonglong;
      ...
      importc: "cusparseSpVecGet", dynlib: libName.}
  ...
  proc cusparseSpVecGetValues*(spVecDescr: cusparseSpVecDescr_t;
                              values: ptr pointer): cusparseStatus_t {.cdecl,
      importc: "cusparseSpVecGetValues", dynlib: libName.}
  ...
  proc cusparseDnVecGetValues*(dnVecDescr: cusparseDnVecDescr_t;
                              values: ptr pointer): cusparseStatus_t {.cdecl,
      importc: "cusparseDnVecGetValues", dynlib: libName.}
  ...
  proc cusparseSpMatGetFormat*(spMatDescr: cusparseConstSpMatDescr_t;
      ...
      cdecl, importc: "cusparseSpMatGetFormat", dynlib: libName.}
  ...
  proc cusparseSpMatGetValues*(spMatDescr: cusparseSpMatDescr_t;
                              values: ptr pointer): cusparseStatus_t {.cdecl,
      importc: "cusparseSpMatGetValues", dynlib: libName.}
  ...
  proc cusparseSpMatGetSize*(spMatDescr: cusparseConstSpMatDescr_t;
                            ...
                            nnz: ptr clonglong): cusparseStatus_t {.cdecl,
      importc: "cusparseSpMatGetSize", dynlib: libName.}
  ...
  proc cusparseSpMatGetAttribute*(spMatDescr: cusparseConstSpMatDescr_t;
                                 ...
                                 data: pointer; dataSize: csize_t): cusparseStatus_t {.
      cdecl, importc: "cusparseSpMatGetAttribute", dynlib: libName.}
  proc cusparseSpMatSetAttribute*(spMatDescr: cusparseSpMatDescr_t;
                                 attribute: cusparseSpMatAttribute_t;
                                 data: pointer; dataSize: csize_t): cusparseStatus_t {.
      cdecl, importc: "cusparseSpMatSetAttribute", dynlib: libName.}
  ## ------------------------------------------------------------------------------
  ##  ### CSR ###
  ...
  proc cusparseCreateConstCsr*(spMatDescr: ptr cusparseConstSpMatDescr_t;
                              ...
                              idxBase: cusparseIndexBase_t;
                              valueType: cudaDataType): cusparseStatus_t {.cdecl,
      importc: "cusparseCreateConstCsr", dynlib: libName.}
  ...
  proc cusparseCreateConstCsc*(spMatDescr: ptr cusparseConstSpMatDescr_t;
                              ...
                              idxBase: cusparseIndexBase_t;
                              valueType: cudaDataType): cusparseStatus_t {.cdecl,
      importc: "cusparseCreateConstCsc", dynlib: libName.}
  ...
  proc cusparseConstCsrGet*(spMatDescr: cusparseConstSpMatDescr_t;
                           rows: ptr clonglong; cols: ptr clonglong;
                           nnz: ptr clonglong; csrRowOffsets: ptr pointer;
                           csrColInd: ptr pointer; csrValues: ptr pointer;
                           csrRowOffsetsType: ptr cusparseIndexType_t;
                           csrColIndType: ptr cusparseIndexType_t;
                           idxBase: ptr cusparseIndexBase_t;
                           valueType: ptr cudaDataType): cusparseStatus_t {.cdecl,
  ...
  proc cusparseConstCscGet*(spMatDescr: cusparseConstSpMatDescr_t;
                           rows: ptr clonglong; cols: ptr clonglong;
                           nnz: ptr clonglong; cscColOffsets: ptr pointer;
                           cscRowInd: ptr pointer; cscValues: ptr pointer;
                           cscColOffsetsType: ptr cusparseIndexType_t;
                           cscRowIndType: ptr cusparseIndexType_t;
                           idxBase: ptr cusparseIndexBase_t;
                           valueType: ptr cudaDataType): cusparseStatus_t {.cdecl,
  ...
  proc cusparseCreateConstCoo*(spMatDescr: ptr cusparseConstSpMatDescr_t;
                              ...
                              idxBase: cusparseIndexBase_t;
                              valueType: cudaDataType): cusparseStatus_t {.cdecl,
      importc: "cusparseCreateConstCoo", dynlib: libName.}
  ...
  proc cusparseConstCooGet*(spMatDescr: cusparseConstSpMatDescr_t;
                           rows: ptr clonglong; cols: ptr clonglong;
                           nnz: ptr clonglong; cooRowInd: ptr pointer;
                           cooColInd: ptr pointer; cooValues: ptr pointer;
                           idxType: ptr cusparseIndexType_t;
                           idxBase: ptr cusparseIndexBase_t;
                           valueType: ptr cudaDataType): cusparseStatus_t {.cdecl,
  ...
  proc cusparseBlockedEllGet*(spMatDescr: cusparseSpMatDescr_t;
                             rows: ptr clonglong; cols: ptr clonglong;
                             ellBlockSize: ptr clonglong; ellCols: ptr clonglong;
                             ellColInd: ptr pointer; ellValue: ptr pointer;
  ...
  proc cusparseDnMatGetValues*(dnMatDescr: cusparseDnMatDescr_t;
                              values: ptr pointer): cusparseStatus_t {.cdecl,
      importc: "cusparseDnMatGetValues", dynlib: libName.}
  ...
  proc cusparseDnMatGetStridedBatch*(dnMatDescr: cusparseConstDnMatDescr_t;
                                    batchCount: ptr cint;
                                    batchStride: ptr clonglong): cusparseStatus_t {.
  ...
  proc cusparseSpVV_bufferSize*(handle: cusparseHandle_t; opX: cusparseOperation_t;
                               ...
                               vecY: cusparseConstDnVecDescr_t; result: pointer;
  ...
  discard "forward decl of cusparseSpSVDescr"
  type
    #cusparseSpSVDescr_t* = ptr cusparseSpSVDescr
    cusparseSpSVDescr_t* = pointer
  ...
  discard "forward decl of cusparseSpSMDescr"
  type
    #cusparseSpSMDescr_t* = ptr cusparseSpSMDescr
    cusparseSpSMDescr_t* = pointer
  ...
  discard "forward decl of cusparseSpGEMMDescr"
  type
    #cusparseSpGEMMDescr_t* = ptr cusparseSpGEMMDescr
    cusparseSpGEMMDescr_t* = pointer
  ...
  proc cusparseSpGEMM_workEstimation*(handle: cusparseHandle_t;
                                     ...
                                     beta: pointer; matC: cusparseSpMatDescr_t;
  ...
  proc cusparseSpGEMM_compute*(handle: cusparseHandle_t; opA: cusparseOperation_t;
                              ...
                              computeType: cudaDataType; alg: cusparseSpGEMMAlg_t;
                              spgemmDescr: cusparseSpGEMMDescr_t;
  ...
  proc cusparseSpGEMMreuse_workEstimation*(handle: cusparseHandle_t;
      ...
      matA: cusparseConstSpMatDescr_t; matB: cusparseConstSpMatDescr_t;
      matC: cusparseSpMatDescr_t; alg: cusparseSpGEMMAlg_t;
      spgemmDescr: cusparseSpGEMMDescr_t; bufferSize1: ptr csize_t;
      externalBuffer1: pointer): cusparseStatus_t {.cdecl,
      importc: "cusparseSpGEMMreuse_workEstimation", dynlib: libName.}
  ...
  proc cusparseSpGEMMreuse_copy*(handle: cusparseHandle_t;
                                opA: cusparseOperation_t;
                                opB: cusparseOperation_t;
                                matA: cusparseConstSpMatDescr_t;
                                matB: cusparseConstSpMatDescr_t;
  ...
  proc cusparseSDDMM_bufferSize*(handle: cusparseHandle_t;
                                opA: cusparseOperation_t;
                                opB: cusparseOperation_t; alpha: pointer;
                                matA: cusparseConstDnMatDescr_t;
                                matB: cusparseConstDnMatDescr_t; beta: pointer;
                                matC: cusparseSpMatDescr_t;
                                computeType: cudaDataType;
                                alg: cusparseSDDMMAlg_t; bufferSize: ptr csize_t): cusparseStatus_t {.
      cdecl, importc: "cusparseSDDMM_bufferSize", dynlib: libName.}
  proc cusparseSDDMM_preprocess*(handle: cusparseHandle_t;
                                opA: cusparseOperation_t;
                                opB: cusparseOperation_t; alpha: pointer;
                                matA: cusparseConstDnMatDescr_t;
                                matB: cusparseConstDnMatDescr_t; beta: pointer;
      ...
      cdecl, importc: "cusparseSDDMM_preprocess", dynlib: libName.}
  ...
  ##  #############################################################################
  discard "forward decl of cusparseSpMMOpPlan"
  type
    #cusparseSpMMOpPlan_t* = ptr cusparseSpMMOpPlan
    cusparseSpMMOpPlan_t* = pointer
