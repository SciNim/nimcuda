...
struct __device_builtin__ cudaArraySparseProperties {
    ...
    culonglong miptailSize;     /**< Total size of the mip tail. */
 ...
 */
typedef __device_builtin__ culonglong cudaGraphConditionalHandle;
...
{
    culonglong flags;              /**< Instantiation flags */
...
typedef __device_builtin__ struct cudaLaunchMemSyncDomainMap_st {
    unsigned char default;                /**< The default domain ID to use for designated kernels */
...
typedef cudaLaunchAttributeID cudaStreamAttrID;
...
typedef cudaLaunchAttributeValue cudaStreamAttrValue;

typedef cudaLaunchAttributeID cudaKernelNodeAttrID;
...
typedef cudaLaunchAttributeValue cudaKernelNodeAttrValue;
