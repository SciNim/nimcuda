...
typedef const struct cusparseSpVecDescr* cusparseConstSpVecDescr_t;
typedef const struct cusparseDnVecDescr* cusparseConstDnVecDescr_t;
typedef const struct cusparseSpMatDescr* cusparseConstSpMatDescr_t;
typedef const struct cusparseDnMatDescr* cusparseConstDnMatDescr_t;
...
cusparseCooSetStridedBatch(cusparseSpMatDescr_t spMatDescr,
                           int                  batchCount,
                           clonglong              batchStride);

cusparseStatus_t CUSPARSEAPI
cusparseCsrSetStridedBatch(cusparseSpMatDescr_t spMatDescr,
                           int                  batchCount,
                           clonglong              offsetsBatchStride,
                           clonglong              columnsValuesBatchStride);

cusparseStatus_t CUSPARSEAPI
cusparseBsrSetStridedBatch(cusparseSpMatDescr_t spMatDescr,
                           int                  batchCount,
                           clonglong              offsetsBatchStride,
                           clonglong              columnsBatchStride,
                           clonglong              ValuesBatchStride);
...
cusparseCreateBsr(cusparseSpMatDescr_t* spMatDescr,
                  ...
                  clonglong               bcols,
                  clonglong               bnnz,
                  clonglong               rowBlockSize,
                  clonglong               colBlockSize,
                  void*                 bsrRowOffsets,
                  void*                 bsrColInd,
                  void*                 bsrValues,
...
cusparseCreateConstBsr(cusparseConstSpMatDescr_t* spMatDescr,
                       ...
                       clonglong                    bcols,
                       clonglong                    bnnz,
                       clonglong                    rowBlockDim,
                       clonglong                    colBlockDim,
