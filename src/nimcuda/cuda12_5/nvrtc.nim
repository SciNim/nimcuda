...
##
##  \ingroup error
##  \brief   The enumerated type nvrtcResult defines API call resultNotKeyWord codes.
...
##
##  \param   [in] resultNotKeyWord CUDA Runtime Compilation API resultNotKeyWord code.
##  \return  Message string for the given #nvrtcResult code.
##

proc nvrtcGetErrorString*(resultNotKeyWord: nvrtcResult): cstring {.cdecl,
    importc: "nvrtcGetErrorString", dynlib: libName.}
## **********************************************************************
##
##
...
##
##  \param   [in]  prog CUDA Runtime Compilation program.
##  \param   [out] ptx  Compiled resultNotKeyWord.
##  \return
##    - \link #nvrtcResult NVRTC_SUCCESS \endlink
##    - \link #nvrtcResult NVRTC_ERROR_INVALID_INPUT \endlink
##    - \link #nvrtcResult NVRTC_ERROR_INVALID_PROGRAM \endlink
...
##
##  \param   [in]  prog CUDA Runtime Compilation program.
##  \param   [out] cubin  Compiled and assembled resultNotKeyWord.
##  \return
##    - \link #nvrtcResult NVRTC_SUCCESS \endlink
##    - \link #nvrtcResult NVRTC_ERROR_INVALID_INPUT \endlink
##    - \link #nvrtcResult NVRTC_ERROR_INVALID_PROGRAM \endlink
...
##  #elif (defined(GNUC) && (__GNUC__ < 4 || (__GNUC__ == 4 && __GNUC_MINOR__ < 5 && !defined(clang))))
...
##
##  \param   [in]  prog CUDA Runtime Compilation program.
##  \param   [out] LTOIR Compiled resultNotKeyWord.
##  \return
##    - \link #nvrtcResult NVRTC_SUCCESS \endlink
##    - \link #nvrtcResult NVRTC_ERROR_INVALID_INPUT \endlink
##    - \link #nvrtcResult NVRTC_ERROR_INVALID_PROGRAM \endlink
...
##
##  \param   [in]  prog CUDA Runtime Compilation program.
##  \param   [out] Optix IR Compiled resultNotKeyWord.
##  \return
##    - \link #nvrtcResult NVRTC_SUCCESS \endlink
##    - \link #nvrtcResult NVRTC_ERROR_INVALID_INPUT \endlink
##    - \link #nvrtcResult NVRTC_ERROR_INVALID_PROGRAM \endlink
...
##        of thread parallelism.  Hence, a good maxrregcount value is the resultNotKeyWord
...
##   * \param   [in] resultNotKeyWord: pointer to std::string in which to store the type name.
##   * \return
##   *  - \link #nvrtcResult NVRTC_SUCCESS \endlink
